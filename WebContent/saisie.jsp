...
<%-- 		<p class="error">${exception }</p> --%>
		<form method="post" action="saveProduit.php">
			  ...
			  <div class="form-group">
		   		 ...
		   		 <input type="hidden" name="id" class="form-control" id="identifiant" placeholder="200000">
		  	  </div>
		  	  
		  	   <div class="form-group">
		   		 <label for="designation">Désignation</label>
		   		 <input type="text" name="designation" class="form-control" id="designation" placeholder="désignation">
		  	  </div>
